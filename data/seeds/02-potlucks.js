  ...
  return knex('potlucks').del()
    .then(function () {
      ...
      return knex('potlucks').insert([
        {id: 1, location: 'The Lakehouse', name: "Andre's Going Away Party", organizer_id: 6, datetime: new Date()},
        ...
        {id: 6, location: 'Six flags', name: 'Roller Coaster Protest Extravaganza', organizer_id: 6, datetime: new Date()},
